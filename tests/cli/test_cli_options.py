...
def check_generated_output(gen_expected_path, gen_result_path,
                           result_manip=None, show_diffs=False):
    """
    ...
    if gen_res_txt != gen_exp_txt:
        ...
        if show_diffs is True:
            ...
            print("use: 'diff %s %s' to find out why"
...
def check_std_output(expected_path, result_path, result_str, result_manip=None,
    ...
    :param show_diffs: bool
        flag to enable showing the difference of two files from command line
...
def check_uncrustify_output(
        uncr_bin, args_arr=(), show_diffs=False,
...
def main(args):
    ...
    arg_show_diffs = bool("--diff" in args)
